<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SpotDealsPage.aspx.cs" Inherits="Tree_Trading.SpotDealsPage" %>
...
<asp:TextBox ID="Amount1TextBox" runat="server" Height="35px"  Width="270px" OnTextChanged="Amount1TextBox_TextChanged"></asp:TextBox>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:TextBox ID="Amoun2TextBox" runat="server" Height="35px" Width="270px" Enabled="False"></asp:TextBox>

    </p>
    <p style="direction: ltr">&nbsp;CCY1&nbsp;

        <asp:DropDownList runat="server"  style="margin-top: 19" Height="35px" Width="328px" ID="DropList1">
        ...
        <asp:DropDownList runat="server"  style="margin-top: 19" Height="35px" Width="270px" ID="DropList2" OnSelectedIndexChanged="DropList1_SelectedIndexChanged">
            <asp:ListItem>EGP</asp:ListItem>
            <asp:ListItem>USD</asp:ListItem>
            <asp:ListItem>SAR</asp:ListItem>
            <asp:ListItem>EUR</asp:ListItem>
            ...
            <p style="direction: ltr">&nbsp;<asp:Label ID="Label7" runat="server" Text="Trade time"></asp:Label>
&nbsp;&nbsp;&nbsp; 
